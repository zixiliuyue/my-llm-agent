 ...
 * Day 12：自包含学习源码。
 *
 * 这个文件属于 day12-model-provider-router，不能 import 其它 day 的源码。
...
export function runDemo(input = createDemoInput()) {
  ...
  },
  {
    ...
    source: "day12:model-provider-router",
  }));
