 ...
 * Day 18：自包含学习源码。
 *
 * 这个文件属于 day18-mcp-adapter-mock，不能 import 其它 day 的源码。
...
export const lesson = Object.freeze({
  ...
  slug: "mcp-adapter-mock",
  // title 是给人看的中文标题，CLI 成功日志会打印它。
  title: "MCP Adapter Mock",
  concepts: [
