 ...
 * Day 22：自包含学习源码。
 *
 * 这个文件属于 day22-mock-chat-channel，不能 import 其它 day 的源码。
...
export const lesson = Object.freeze({
  ...
  slug: "mock-chat-channel",
  // title 是给人看的中文标题，CLI 成功日志会打印它。
  title: "Mock Chat Channel",
  concepts: [
...
export function runDemo(input = createDemoInput()) {
  ...
  },
  {
    ...
    source: "day22:mock-chat-channel",
  }));
