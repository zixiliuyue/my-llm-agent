 ...
 * Day 26：自包含学习源码。
 *
 * 这个文件属于 day26-doctor-config-checker，不能 import 其它 day 的源码。
...
export const lesson = Object.freeze({
  ...
  slug: "doctor-config-checker",
  // title 是给人看的中文标题，CLI 成功日志会打印它。
  title: "Doctor Config Checker",
  concepts: [
...
export function runDemo(input = createDemoInput()) {
  ...
  },
  {
    ...
    source: "day26:doctor-config-checker",
  }));
