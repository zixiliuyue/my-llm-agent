 ...
 * Day 9：自包含学习源码。
 *
 * 这个文件属于 day09-websocket-gateway，不能 import 其它 day 的源码。
...
export function runDemo(input = createDemoInput()) {
  ...
  },
  {
    ...
    source: "day09:websocket-gateway",
  }));
