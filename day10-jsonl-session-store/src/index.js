 ...
 * Day 10：自包含学习源码。
 *
 * 这个文件属于 day10-jsonl-session-store，不能 import 其它 day 的源码。
...
export const lesson = Object.freeze({
  ...
  slug: "jsonl-session-store",
  // title 是给人看的中文标题，CLI 成功日志会打印它。
  title: "JSONL Session Store",
  concepts: [
...
export function runDemo(input = createDemoInput()) {
  ...
  },
  {
    ...
    source: "day10:jsonl-session-store",
  }));
