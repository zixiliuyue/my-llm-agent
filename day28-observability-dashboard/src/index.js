 ...
 * Day 28：自包含学习源码。
 *
 * 这个文件属于 day28-observability-dashboard，不能 import 其它 day 的源码。
 * 注释说明保留在文件顶部，帮助学习时先理解本文件职责。
 */
/**
 * Day 28：Observability Dashboard。
 *
...
export const lesson = Object.freeze({
  ...
  concepts: [
    ...
    "学习把 runs、latency、tool calls、errors 做成观察面板。",
    "页面使用 mock 指标。"
  ],
  artifacts: [
...
export function runDemo(input = createDemoInput()) {
  ...
  },
  {
    ...
    source: "day28:observability-dashboard",
  }));
